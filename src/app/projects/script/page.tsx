  ...
  return (
    ...
    <main className=" flex flex-col w-[350px] h-[400px] rounded border-2 border-slate-100 shadow shadow-purple-600 p-8 mt-5 m-auto">
      ...
      Surprize Message Application <br />
            ...
            <h2 className='text-center text-white font-medium'>CLI Command: npm i surprize-message123-by-mussarat</h2>
            <div>
        ...
        <main className="flex flex-col w-[350px] h-[400px] rounded border-2 border-slate-100 shadow shadow-purple-600 p-8 mt-5 m-auto">
            ...
            <h2 className=' text-center text-white font-medium'>CLI Command: npm i atm-by-mussarat</h2>
            <div>
        ...
        <main className="flex flex-col w-[350px] h-[400px] rounded border-2 border-slate-100 shadow shadow-purple-600 p-8 mt-5 m-auto">
            ...
            <h2 className='text-center text-white font-medium'>CLI Command: npm i student-management-sys-by-mussarat</h2>
            <div>
